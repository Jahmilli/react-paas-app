  ...
  render() {
    return (
      <div>
        ...
        photo2={Images.welcomeNight3}
        heading2="2018 Welcome Night"
        link2="https://www.facebook.com/events/1767086486664256/"

        photo3={Images.futureEvents.qaSpacePanelNight2018}
        heading3="Q&A Space Panel Night: So you want my job?"
        link3="https://www.facebook.com/events/152272708820985/"

        photo4={Images.iacBanner}/>
      </div>
    );
  }
}
